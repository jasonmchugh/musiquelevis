...
$rocket_cookie_hash = '9b6d51a85205bbf592c532bb77b9fe20';
$rocket_logged_in_cookie = 'wordpress_logged_in_9b6d51a85205bbf592c532bb77b9fe20';
$rocket_cache_mobile_files_tablet = 'desktop';
$rocket_cache_ssl = 1;
$rocket_cache_reject_uri = '/(?:.+/)?feed(?:/(?:.+/?)?)?$|/(?:.+/)?embed/|/gestion/|/commande/(.*)|/panier/|/mon-compte/(.*)|/wc-api/v(.*)|/(index\.php/)?(.*)wp\-json(/.*|$)';
...
$rocket_secret_cache_key = '5afb0a3f8a83b823382530';
