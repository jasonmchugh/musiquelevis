...
<div id="payment" class="woocommerce-checkout-payment">
	...
	<div class="form-row place-order">
		...
		<?php echo apply_filters( 'woocommerce_order_button_html', '<input type="submit" class="button btn--yellow" value="Commander" />' ); ?>
...
<?php
if ( ! is_ajax() ) {
	echo '<br /><p><a href="' . get_permalink( 9 ) . '" class="button btn--blue">' . __( 'Retour au panier', 'bravad' ) . '</a></p>';
