...
<div class="_row">
	<h1><?php _e('Confirmation de commande', 'bravad'); ?></h1>
</div>

<div class="_row errorpage">
	<div class="_col _col--xl-12 _col--md-12 _col--sm-12">
		...
		<a class="button btn--yellow" href="<?php echo esc_url( wc_get_page_permalink( 'cart' ) ); ?>"><?php _e( 'Return to cart', 'woocommerce' ) ?></a>
	</div>
</div>