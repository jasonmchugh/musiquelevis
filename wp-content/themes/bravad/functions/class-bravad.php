...
if ( ! class_exists( 'Bravad' ) ) :
	...
	class Bravad {
		 ...
		 */
		public static function bravad_admin_footer_text() {
			echo sprintf( '<span id="footer-thankyou">%s <a href="%s" target="_blank">Bravad</a> | %s <a href="%s" target="_blank">WordPress</a></span>',
		...
		public function bravad_custom_login() {
			echo '<style type="text/css">
				...
				.login h1 {
					background: url(' . get_template_directory_uri() . '/assets/dist/img/login-logo.png) no-repeat scroll center center / auto 100%;
					width: 100%;
					height: 50px;
				}
				.login form {
