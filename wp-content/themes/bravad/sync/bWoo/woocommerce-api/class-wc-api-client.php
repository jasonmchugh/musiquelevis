...
class WC_API_Client {
	...
	/** @var string API URL, e.g. http://www.woothemes.com/wp-json/wc/v2 */
	public $api_url;
	...
	/** @var WC_API_Client_Resource_Product_Categories instance */
	...
	public function init_resources() {
		...
		$resources = array(
			...
			'WC_API_Client_Resource_Product_Categories' => 'product_categories',
