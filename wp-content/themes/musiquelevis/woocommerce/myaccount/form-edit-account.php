...
<div class="_row">
	<h1><?php _e('Détails du compte', 'bravad'); ?></h1>
</div>
	...
	<div class="woo__content _col _col--xl-9 _col--sm-12">
		...
		<form class="woocommerce-EditAccountForm edit-account" action="" method="post">
			...
			<p>
				...
				<input type="submit" class="woocommerce-Button btn--yellow button" name="save_account_details" value="<?php esc_attr_e( 'Save changes', 'woocommerce' ); ?>" />
