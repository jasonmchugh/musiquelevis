...
<div class="_row" id="customer_login">
	<div class="_col _col--xl-2 u-hidden-md"></div>
		...
		<div class="login__form">
			...
			<form class="woocommerce-form woocommerce-form-login login" method="post">
				...
				<p class="form-row">
					...
					<input type="submit" class="woocommerce-Button btn--yellow button" name="login" value="<?php esc_attr_e( 'Login', 'woocommerce' ); ?>" />
				</p>
				<p class="form-row">
...
<?php if ( get_option( 'woocommerce_enable_myaccount_registration' ) === 'yes' ) : ?>
	<div class="_col _col--xl-4 _col--md-6 _col--sm-12">
		...
		<h2 class="h1"><?php _e( 'Register', 'woocommerce' ); ?></h2>
		...
		<form method="post" class="register">
			...
			<p class="woocommerce-FormRow form-row">
				...
				<input type="submit" class="woocommerce-Button btn--yellow button" name="register" value="<?php esc_attr_e( 'Register', 'woocommerce' ); ?>" />
			</p>
