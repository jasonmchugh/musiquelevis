...
<form id="order_review" method="post">
	...
	<div id="payment">
		...
		<div class="form-row">
			...
			<?php echo apply_filters( 'woocommerce_pay_order_button_html', '<input type="submit" class="button btn--yellow" id="place_order" value="Commander" data-value="Commander" />' ); ?>
